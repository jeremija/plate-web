define(['extendable', 'logger', 'events/EventManager'],
    function(Extendable, Logger, EventManager) {

    /**
     * @event events/EventManager#page-loading-start
     */

    /**
     * @event events/EventManager#page-loading-end
     * @param {Error} err
     * @param {Page}  page
     */
     ...
     * @listens events/EventManager#page-route-not-found
     * @fires EventManager#page-loading-start
     * @fires EventManager#page-loading-end
     */
