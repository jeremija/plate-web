    ...
    var AjaxPrototype = /** @lends Ajax.prototype **/ {
        ...
        _ajaxHandleError: function(p_params, textStatus, error) {
            ...
            if (!skipMessage && error.key) {
                ...
                this.events.dispatch('msg-error', 'error.unknown');
            }
