define(['bootstrap', 'modules/askYesNoMod', 'jquery', 'knockout', 'events/EventManager'],
    function(bootstrap, yesno, $, ko, EventManager) {

    describe('modules/askYesNoMod-test', function() {
        ...
        before(function() {
            ...
            yesno.bind($el[0]);
            $el.hide(0);
            events = new EventManager('modules/askYesNoMod-test');
        });
        after(function() {
            ko.cleanNode($el[0]);
            $('#test').html('');
